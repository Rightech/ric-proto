...
class SMTP final {
 public:
  ...
  typedef WithAsyncMethod_Send<WithAsyncMethod_GatewayInfo<Service > > AsyncService;
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_Send : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
  ...
  typedef ExperimentalWithCallbackMethod_Send<ExperimentalWithCallbackMethod_GatewayInfo<Service > > ExperimentalCallbackService;
  template <class BaseClass>
  class WithGenericMethod_Send : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
  ...
  typedef WithStreamedUnaryMethod_Send<WithStreamedUnaryMethod_GatewayInfo<Service > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_Send<WithStreamedUnaryMethod_GatewayInfo<Service > > StreamedService;
};
