...
func (x *AuthObjectRequest) GetBot() bool {
	if x != nil {
		return x.Bot
	}
	return false
...
type AuthObjectResponse struct {
	...
	FullPacketMode bool                   `protobuf:"varint,14,opt,name=full_packet_mode,json=fullPacketMode,proto3" json:"full_packet_mode,omitempty"`
...
func (x *AuthObjectResponse) GetFullPacketMode() bool {
	if x != nil {
		return x.FullPacketMode
	}
	return false
}

func (x *AuthObjectResponse) GetOrgId() string {
	if x != nil {
		return x.OrgId
	}
	return ""
...
type QueryRepeatersRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	WithObjects bool     `protobuf:"varint,1,opt,name=with_objects,json=withObjects,proto3" json:"with_objects,omitempty"`
	Protocols   []string `protobuf:"bytes,2,rep,name=protocols,proto3" json:"protocols,omitempty"`
	RepeaterIds []string `protobuf:"bytes,3,rep,name=repeater_ids,json=repeaterIds,proto3" json:"repeater_ids,omitempty"`
	ObjectIds   []string `protobuf:"bytes,4,rep,name=object_ids,json=objectIds,proto3" json:"object_ids,omitempty"`
}

func (x *QueryRepeatersRequest) Reset() {
	*x = QueryRepeatersRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueryRepeatersRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryRepeatersRequest) ProtoMessage() {}

func (x *QueryRepeatersRequest) ProtoReflect() protoreflect.Message {
	mi := &file_ric_auth_ricauth_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryRepeatersRequest.ProtoReflect.Descriptor instead.
func (*QueryRepeatersRequest) Descriptor() ([]byte, []int) {
	return file_ric_auth_ricauth_proto_rawDescGZIP(), []int{10}
}

func (x *QueryRepeatersRequest) GetWithObjects() bool {
	if x != nil {
...
func (x *QueryRepeatersRequest) GetProtocols() []string {
	if x != nil {
		return x.Protocols
	}
	return nil
...
func (x *QueryRepeatersRequest) GetRepeaterIds() []string {
	if x != nil {
...
func (x *QueryRepeatersRequest) GetObjectIds() []string {
	if x != nil {
		return x.ObjectIds
	}
	return nil
...
type RepeaterInfo struct {
	...
	RepeaterId string                             `protobuf:"bytes,1,opt,name=repeater_id,json=repeaterId,proto3" json:"repeater_id,omitempty"`
	...
	Objects    []*RepeaterInfo_ObjectRepeaterInfo `protobuf:"bytes,10,rep,name=objects,proto3" json:"objects,omitempty"`
}

func (x *RepeaterInfo) Reset() {
	*x = RepeaterInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ric_auth_ricauth_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RepeaterInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RepeaterInfo) ProtoMessage() {}

func (x *RepeaterInfo) ProtoReflect() protoreflect.Message {
	mi := &file_ric_auth_ricauth_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RepeaterInfo.ProtoReflect.Descriptor instead.
func (*RepeaterInfo) Descriptor() ([]byte, []int) {
	return file_ric_auth_ricauth_proto_rawDescGZIP(), []int{11}
}

func (x *RepeaterInfo) GetRepeaterId() string {
	if x != nil {
		return x.RepeaterId
	}
	return ""
...
func (x *RepeaterInfo) GetProtocol() string {
	if x != nil {
		return x.Protocol
	}
	return ""
...
func (x *RepeaterInfo) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *RepeaterInfo) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
func (x *RepeaterInfo) GetPort() int32 {
	if x != nil {
		return x.Port
	}
	return 0
...
func (x *RepeaterInfo) GetConfig() string {
	if x != nil {
		return x.Config
	}
	return ""
...
func (x *RepeaterInfo) GetObjects() []*RepeaterInfo_ObjectRepeaterInfo {
	if x != nil {
		return x.Objects
	}
	return nil
...
type RepeatersResponse struct {
	...
	Repeaters []*RepeaterInfo `protobuf:"bytes,1,rep,name=repeaters,proto3" json:"repeaters,omitempty"`
}

func (x *RepeatersResponse) Reset() {
	*x = RepeatersResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ric_auth_ricauth_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RepeatersResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RepeatersResponse) ProtoMessage() {}

func (x *RepeatersResponse) ProtoReflect() protoreflect.Message {
	mi := &file_ric_auth_ricauth_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RepeatersResponse.ProtoReflect.Descriptor instead.
func (*RepeatersResponse) Descriptor() ([]byte, []int) {
	return file_ric_auth_ricauth_proto_rawDescGZIP(), []int{12}
}

func (x *RepeatersResponse) GetRepeaters() []*RepeaterInfo {
	if x != nil {
		return x.Repeaters
	}
	return nil
...
func (x *AuthObjectRequest_AuthObjectCert) Reset() {
	*x = AuthObjectRequest_AuthObjectCert{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ric_auth_ricauth_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
type RepeaterInfo_ObjectRepeaterInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ObjectId       string `protobuf:"bytes,1,opt,name=object_id,json=objectId,proto3" json:"object_id,omitempty"`
	RepeaterConfig string `protobuf:"bytes,2,opt,name=repeater_config,json=repeaterConfig,proto3" json:"repeater_config,omitempty"`
	Status         string `protobuf:"bytes,3,opt,name=status,proto3" json:"status,omitempty"`
}

func (x *RepeaterInfo_ObjectRepeaterInfo) Reset() {
	*x = RepeaterInfo_ObjectRepeaterInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ric_auth_ricauth_proto_msgTypes[16]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RepeaterInfo_ObjectRepeaterInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RepeaterInfo_ObjectRepeaterInfo) ProtoMessage() {}

func (x *RepeaterInfo_ObjectRepeaterInfo) ProtoReflect() protoreflect.Message {
	mi := &file_ric_auth_ricauth_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RepeaterInfo_ObjectRepeaterInfo.ProtoReflect.Descriptor instead.
func (*RepeaterInfo_ObjectRepeaterInfo) Descriptor() ([]byte, []int) {
	return file_ric_auth_ricauth_proto_rawDescGZIP(), []int{11, 0}
}

func (x *RepeaterInfo_ObjectRepeaterInfo) GetObjectId() string {
	if x != nil {
		return x.ObjectId
	}
	return ""
...
func (x *RepeaterInfo_ObjectRepeaterInfo) GetRepeaterConfig() string {
	if x != nil {
		return x.RepeaterConfig
	}
	return ""
}

func (x *RepeaterInfo_ObjectRepeaterInfo) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
var file_ric_auth_ricauth_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x22, 0xda, 0x02, 0x0a, 0x11, 0x41, 0x75, 0x74, 0x68, 0x4f, 0x62, 0x6a, 0x65, 0x63,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x69, 0x70, 0x76, 0x36, 0x12, 0x10, 0x0a, 0x03, 0x62, 0x6f, 0x74,
	0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x03, 0x62, 0x6f, 0x74, 0x1a, 0x42, 0x0a, 0x0e, 0x41,
	0x75, 0x74, 0x68, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x65, 0x72, 0x74, 0x12, 0x0e, 0x0a,
	0x02, 0x63, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x63, 0x6e, 0x12, 0x20, 0x0a,
	...
	0xb0, 0x05, 0x0a, 0x12, 0x41, 0x75, 0x74, 0x68, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65,
	...
	,
	...
	,
	...
	0x61, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e,
	0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65,
	0x6e, 0x63, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x61, 0x72, 0x73, 0x65, 0x72, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x61, 0x72, 0x73, 0x65, 0x72, 0x22, 0x5a, 0x0a, 0x0a, 0x53,
	0x74, 0x61, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c,
	...
	,
	...
	0x4b, 0x65, 0x79, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x12, 0x1b, 0x0a, 0x09, 0x69,
	...
	0x70, 0x69, 0x72, 0x65, 0x73, 0x41, 0x74, 0x22, 0x2d, 0x0a, 0x10, 0x4d, 0x6f, 0x64, 0x65, 0x6c,
	...
	,
	...
	,
	...
	,
...
var file_ric_auth_ricauth_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_ric_auth_ricauth_proto_goTypes = []interface{}{
	...
	(*QueryRepeatersRequest)(nil),            // 10: ric.auth.QueryRepeatersRequest
	(*RepeaterInfo)(nil),                     // 11: ric.auth.RepeaterInfo
	(*RepeatersResponse)(nil),                // 12: ric.auth.RepeatersResponse
	(*AuthObjectRequest_AuthObjectCert)(nil), // 13: ric.auth.AuthObjectRequest.AuthObjectCert
	nil,                                      // 14: ric.auth.AuthObjectResponse.LicenseEntry
	nil,                                      // 15: ric.auth.AuthObjectResponse.StatsEntry
	(*RepeaterInfo_ObjectRepeaterInfo)(nil),  // 16: ric.auth.RepeaterInfo.ObjectRepeaterInfo
}
var file_ric_auth_ricauth_proto_depIdxs = []int32{
	13, // 0: ric.auth.AuthObjectRequest.cert:type_name -> ric.auth.AuthObjectRequest.AuthObjectCert
	2,  // 1: ric.auth.AuthObjectResponse.arguments:type_name -> ric.auth.AuthObjectArgument
	14, // 2: ric.auth.AuthObjectResponse.license:type_name -> ric.auth.AuthObjectResponse.LicenseEntry
	15, // 3: ric.auth.AuthObjectResponse.stats:type_name -> ric.auth.AuthObjectResponse.StatsEntry
	2,  // 4: ric.auth.ModelInfoResponse.arguments:type_name -> ric.auth.AuthObjectArgument
	16, // 5: ric.auth.RepeaterInfo.objects:type_name -> ric.auth.RepeaterInfo.ObjectRepeaterInfo
	11, // 6: ric.auth.RepeatersResponse.repeaters:type_name -> ric.auth.RepeaterInfo
	3,  // 7: ric.auth.AuthObjectResponse.StatsEntry.value:type_name -> ric.auth.StatRecord
	0,  // 8: ric.auth.RicAuth.AuthObject:input_type -> ric.auth.AuthObjectRequest
	6,  // 9: ric.auth.RicAuth.GetModelInfo:input_type -> ric.auth.ModelInfoRequest
	4,  // 10: ric.auth.RicAuth.IssueCert:input_type -> ric.auth.IssueCertRequest
	8,  // 11: ric.auth.RicAuth.SendOffline:input_type -> ric.auth.ObjectGateRequest
	8,  // 12: ric.auth.RicAuth.SendModelUpdate:input_type -> ric.auth.ObjectGateRequest
	10, // 13: ric.auth.RicAuth.QueryRepeaters:input_type -> ric.auth.QueryRepeatersRequest
	1,  // 14: ric.auth.RicAuth.AuthObject:output_type -> ric.auth.AuthObjectResponse
	7,  // 15: ric.auth.RicAuth.GetModelInfo:output_type -> ric.auth.ModelInfoResponse
	5,  // 16: ric.auth.RicAuth.IssueCert:output_type -> ric.auth.IssueCertResponse
	9,  // 17: ric.auth.RicAuth.SendOffline:output_type -> ric.auth.ObjectGateResponse
	9,  // 18: ric.auth.RicAuth.SendModelUpdate:output_type -> ric.auth.ObjectGateResponse
	12, // 19: ric.auth.RicAuth.QueryRepeaters:output_type -> ric.auth.RepeatersResponse
...
func file_ric_auth_ricauth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ric_auth_ricauth_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryRepeatersRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ric_auth_ricauth_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RepeaterInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ric_auth_ricauth_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RepeatersResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ric_auth_ricauth_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ric_auth_ricauth_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RepeaterInfo_ObjectRepeaterInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type RicAuthClient interface {
	...
	QueryRepeaters(ctx context.Context, in *QueryRepeatersRequest, opts ...grpc.CallOption) (*RepeatersResponse, error)
}
...
func (c *ricAuthClient) QueryRepeaters(ctx context.Context, in *QueryRepeatersRequest, opts ...grpc.CallOption) (*RepeatersResponse, error) {
	out := new(RepeatersResponse)
	err := c.cc.Invoke(ctx, "/ric.auth.RicAuth/QueryRepeaters", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RicAuthServer interface {
	...
	QueryRepeaters(context.Context, *QueryRepeatersRequest) (*RepeatersResponse, error)
}
...
func (*UnimplementedRicAuthServer) QueryRepeaters(context.Context, *QueryRepeatersRequest) (*RepeatersResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QueryRepeaters not implemented")
}
...
func _RicAuth_QueryRepeaters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryRepeatersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RicAuthServer).QueryRepeaters(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ric.auth.RicAuth/QueryRepeaters",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RicAuthServer).QueryRepeaters(ctx, req.(*QueryRepeatersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _RicAuth_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "QueryRepeaters",
			Handler:    _RicAuth_QueryRepeaters_Handler,
		},
	},
