...
func (x *WaitCondition) GetTimeout() string {
	if x != nil {
		return x.Timeout
	}
	return ""
...
func (x *WaitCondition) GetEvent() string {
	if x != nil {
		return x.Event
	}
	return ""
...
func (x *WaitCondition) GetState() string {
	if x != nil {
		return x.State
	}
	return ""
...
func (x *WaitCondition) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
type RunAutomatonRequest struct {
	...
	ObjectId    string                        `protobuf:"bytes,2,opt,name=object_id,json=objectId,proto3" json:"object_id,omitempty"`
	AutomatonId string                        `protobuf:"bytes,3,opt,name=automaton_id,json=automatonId,proto3" json:"automaton_id,omitempty"`
	Wait        *WaitCondition                `protobuf:"bytes,4,opt,name=wait,proto3" json:"wait,omitempty"`
...
func (x *RunAutomatonRequest) GetWait() *WaitCondition {
	if x != nil {
		return x.Wait
	}
	return nil
...
func (x *WaitEventRequest) GetWait() *WaitCondition {
	if x != nil {
		return x.Wait
	}
	return nil
...
func (x *UpdateAutomatonVarsResponse) Reset() {
	*x = UpdateAutomatonVarsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ric_logic_v3_riclogicv3_proto_msgTypes[25]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdateAutomatonVarsResponse) Descriptor() ([]byte, []int) {
	return file_ric_logic_v3_riclogicv3_proto_rawDescGZIP(), []int{25}
}
...
type TouchEventSubscriptionRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TouchEventSubscriptionRequest) Reset() {
	*x = TouchEventSubscriptionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ric_logic_v3_riclogicv3_proto_msgTypes[26]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *TouchEventSubscriptionRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TouchEventSubscriptionRequest) ProtoMessage() {}

func (x *TouchEventSubscriptionRequest) ProtoReflect() protoreflect.Message {
	mi := &file_ric_logic_v3_riclogicv3_proto_msgTypes[26]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TouchEventSubscriptionRequest.ProtoReflect.Descriptor instead.
func (*TouchEventSubscriptionRequest) Descriptor() ([]byte, []int) {
	return file_ric_logic_v3_riclogicv3_proto_rawDescGZIP(), []int{26}
}

func (x *TouchEventSubscriptionRequest) GetCtx() *UserContext {
	if x != nil {
		return x.Ctx
	}
	return nil
...
func (x *TouchEventSubscriptionRequest) GetObjectId() string {
	if x != nil {
		return x.ObjectId
	}
	return ""
...
func (x *TouchEventSubscriptionRequest) GetAutomatonId() string {
	if x != nil {
		return x.AutomatonId
	}
	return ""
...
func (x *TouchEventSubscriptionRequest) GetTtl() int32 {
	if x != nil {
		return x.Ttl
	}
	return 0
...
type TouchEventSubscriptionResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *TouchEventSubscriptionResponse) Reset() {
	*x = TouchEventSubscriptionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ric_logic_v3_riclogicv3_proto_msgTypes[27]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *TouchEventSubscriptionResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TouchEventSubscriptionResponse) ProtoMessage() {}

func (x *TouchEventSubscriptionResponse) ProtoReflect() protoreflect.Message {
	mi := &file_ric_logic_v3_riclogicv3_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TouchEventSubscriptionResponse.ProtoReflect.Descriptor instead.
func (*TouchEventSubscriptionResponse) Descriptor() ([]byte, []int) {
	return file_ric_logic_v3_riclogicv3_proto_rawDescGZIP(), []int{27}
}
...
func (x *SchedulerInterval) Reset() {
	*x = SchedulerInterval{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ric_logic_v3_riclogicv3_proto_msgTypes[28]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SchedulerInterval) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SchedulerInterval) ProtoMessage() {}

func (x *SchedulerInterval) ProtoReflect() protoreflect.Message {
	mi := &file_ric_logic_v3_riclogicv3_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SchedulerInterval.ProtoReflect.Descriptor instead.
func (*SchedulerInterval) Descriptor() ([]byte, []int) {
	return file_ric_logic_v3_riclogicv3_proto_rawDescGZIP(), []int{28}
}

func (x *SchedulerInterval) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
func (x *SchedulerInterval) GetTo() string {
	if x != nil {
		return x.To
	}
	return ""
...
func (x *SchedulerInterval) GetDelay() int32 {
	if x != nil {
		return x.Delay
	}
	return 0
...
type GetSchedulerNextInvocationRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Tz        int32                `protobuf:"varint,1,opt,name=tz,proto3" json:"tz,omitempty"`
	Month     []int32              `protobuf:"varint,2,rep,packed,name=month,proto3" json:"month,omitempty"`
	DayOfWeek []int32              `protobuf:"varint,3,rep,packed,name=day_of_week,json=dayOfWeek,proto3" json:"day_of_week,omitempty"`
	Date      []int32              `protobuf:"varint,4,rep,packed,name=date,proto3" json:"date,omitempty"`
	Times     []string             `protobuf:"bytes,5,rep,name=times,proto3" json:"times,omitempty"`
	Intervals []*SchedulerInterval `protobuf:"bytes,6,rep,name=intervals,proto3" json:"intervals,omitempty"`
}

func (x *GetSchedulerNextInvocationRequest) Reset() {
	*x = GetSchedulerNextInvocationRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ric_logic_v3_riclogicv3_proto_msgTypes[29]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetSchedulerNextInvocationRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSchedulerNextInvocationRequest) ProtoMessage() {}

func (x *GetSchedulerNextInvocationRequest) ProtoReflect() protoreflect.Message {
	mi := &file_ric_logic_v3_riclogicv3_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSchedulerNextInvocationRequest.ProtoReflect.Descriptor instead.
func (*GetSchedulerNextInvocationRequest) Descriptor() ([]byte, []int) {
	return file_ric_logic_v3_riclogicv3_proto_rawDescGZIP(), []int{29}
}

func (x *GetSchedulerNextInvocationRequest) GetTz() int32 {
	if x != nil {
		return x.Tz
	}
	return 0
...
func (x *GetSchedulerNextInvocationRequest) GetMonth() []int32 {
	if x != nil {
		return x.Month
	}
	return nil
...
func (x *GetSchedulerNextInvocationRequest) GetDayOfWeek() []int32 {
	if x != nil {
		return x.DayOfWeek
	}
	return nil
...
func (x *GetSchedulerNextInvocationRequest) GetDate() []int32 {
	if x != nil {
		return x.Date
	}
	return nil
...
func (x *GetSchedulerNextInvocationRequest) GetTimes() []string {
	if x != nil {
		return x.Times
	}
	return nil
...
func (x *GetSchedulerNextInvocationRequest) GetIntervals() []*SchedulerInterval {
	if x != nil {
		return x.Intervals
	}
	return nil
...
type GetSchedulerNextInvocationResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetSchedulerNextInvocationResponse) Reset() {
	*x = GetSchedulerNextInvocationResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ric_logic_v3_riclogicv3_proto_msgTypes[30]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetSchedulerNextInvocationResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSchedulerNextInvocationResponse) ProtoMessage() {}

func (x *GetSchedulerNextInvocationResponse) ProtoReflect() protoreflect.Message {
	mi := &file_ric_logic_v3_riclogicv3_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSchedulerNextInvocationResponse.ProtoReflect.Descriptor instead.
func (*GetSchedulerNextInvocationResponse) Descriptor() ([]byte, []int) {
	return file_ric_logic_v3_riclogicv3_proto_rawDescGZIP(), []int{30}
}

func (x *GetSchedulerNextInvocationResponse) GetMs() int64 {
	if x != nil {
		return x.Ms
	}
	return 0
...
var file_ric_logic_v3_riclogicv3_proto_rawDesc = []byte{
	...
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x6d, 0x0a, 0x0d, 0x57, 0x61, 0x69, 0x74, 0x43,
	0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x74, 0x69, 0x6d, 0x65,
	0x6f, 0x75, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f,
	0x75, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x18, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x73,
	0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x22, 0x8a, 0x02, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65,
	...
	0x68, 0x6f, 0x73, 0x74, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x08, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x61, 0x75, 0x74,
	0x6f, 0x6d, 0x61, 0x74, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0b, 0x61, 0x75, 0x74, 0x6f, 0x6d, 0x61, 0x74, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0xab, 0x02, 0x0a,
	0x1a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x75, 0x74, 0x6f, 0x6d, 0x61, 0x74, 0x6f, 0x6e,
	0x56, 0x61, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2b, 0x0a, 0x03, 0x63,
	...
	,
	...
	,
}
...
var file_ric_logic_v3_riclogicv3_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_ric_logic_v3_riclogicv3_proto_goTypes = []interface{}{
	...
	(*WaitCondition)(nil),                      // 8: ric.logic.v3.WaitCondition
	(*GetInstanceInfoRequest)(nil),             // 9: ric.logic.v3.GetInstanceInfoRequest
	(*GetInstanceInfoResponse)(nil),            // 10: ric.logic.v3.GetInstanceInfoResponse
	(*StartAutomatonRequest)(nil),              // 11: ric.logic.v3.StartAutomatonRequest
	(*StartAutomatonMultiRequest)(nil),         // 12: ric.logic.v3.StartAutomatonMultiRequest
	(*StartAutomatonResponse)(nil),             // 13: ric.logic.v3.StartAutomatonResponse
	(*StopAutomatonRequest)(nil),               // 14: ric.logic.v3.StopAutomatonRequest
	(*RunAutomatonRequest)(nil),                // 15: ric.logic.v3.RunAutomatonRequest
	(*StopAutomatonResponse)(nil),              // 16: ric.logic.v3.StopAutomatonResponse
	(*GetAutomatonsRequest)(nil),               // 17: ric.logic.v3.GetAutomatonsRequest
	(*GetAutomatonsResponse)(nil),              // 18: ric.logic.v3.GetAutomatonsResponse
	(*EmitEventRequest)(nil),                   // 19: ric.logic.v3.EmitEventRequest
	(*EmitEventResponse)(nil),                  // 20: ric.logic.v3.EmitEventResponse
	(*WaitEventRequest)(nil),                   // 21: ric.logic.v3.WaitEventRequest
	(*WaitEventResponse)(nil),                  // 22: ric.logic.v3.WaitEventResponse
	(*GetRuntimeInfoRequest)(nil),              // 23: ric.logic.v3.GetRuntimeInfoRequest
	(*UpdateAutomatonVarsRequest)(nil),         // 24: ric.logic.v3.UpdateAutomatonVarsRequest
	(*UpdateAutomatonVarsResponse)(nil),        // 25: ric.logic.v3.UpdateAutomatonVarsResponse
	(*TouchEventSubscriptionRequest)(nil),      // 26: ric.logic.v3.TouchEventSubscriptionRequest
	(*TouchEventSubscriptionResponse)(nil),     // 27: ric.logic.v3.TouchEventSubscriptionResponse
	(*SchedulerInterval)(nil),                  // 28: ric.logic.v3.SchedulerInterval
	(*GetSchedulerNextInvocationRequest)(nil),  // 29: ric.logic.v3.GetSchedulerNextInvocationRequest
	(*GetSchedulerNextInvocationResponse)(nil), // 30: ric.logic.v3.GetSchedulerNextInvocationResponse
	nil, // 31: ric.logic.v3.AutomatonInfo.VarsEntry
	nil, // 32: ric.logic.v3.StartAutomatonRequest.VarsEntry
	nil, // 33: ric.logic.v3.RunAutomatonRequest.VarsEntry
	nil, // 34: ric.logic.v3.UpdateAutomatonVarsRequest.VarsEntry
	nil, // 35: ric.logic.v3.UpdateAutomatonVarsResponse.VarsEntry
}
var file_ric_logic_v3_riclogicv3_proto_depIdxs = []int32{
	...
	31, // 6: ric.logic.v3.AutomatonInfo.vars:type_name -> ric.logic.v3.AutomatonInfo.VarsEntry
	...
	32, // 11: ric.logic.v3.StartAutomatonRequest.vars:type_name -> ric.logic.v3.StartAutomatonRequest.VarsEntry
	...
	8,  // 16: ric.logic.v3.RunAutomatonRequest.wait:type_name -> ric.logic.v3.WaitCondition
	33, // 17: ric.logic.v3.RunAutomatonRequest.vars:type_name -> ric.logic.v3.RunAutomatonRequest.VarsEntry
	4,  // 18: ric.logic.v3.StopAutomatonResponse.automaton:type_name -> ric.logic.v3.AutomatonInfo
	4,  // 19: ric.logic.v3.GetAutomatonsResponse.automatons:type_name -> ric.logic.v3.AutomatonInfo
	0,  // 20: ric.logic.v3.EmitEventRequest.ctx:type_name -> ric.logic.v3.UserContext
	0,  // 21: ric.logic.v3.WaitEventRequest.ctx:type_name -> ric.logic.v3.UserContext
	8,  // 22: ric.logic.v3.WaitEventRequest.wait:type_name -> ric.logic.v3.WaitCondition
	0,  // 23: ric.logic.v3.UpdateAutomatonVarsRequest.ctx:type_name -> ric.logic.v3.UserContext
	34, // 24: ric.logic.v3.UpdateAutomatonVarsRequest.vars:type_name -> ric.logic.v3.UpdateAutomatonVarsRequest.VarsEntry
	35, // 25: ric.logic.v3.UpdateAutomatonVarsResponse.vars:type_name -> ric.logic.v3.UpdateAutomatonVarsResponse.VarsEntry
	0,  // 26: ric.logic.v3.TouchEventSubscriptionRequest.ctx:type_name -> ric.logic.v3.UserContext
	28, // 27: ric.logic.v3.GetSchedulerNextInvocationRequest.intervals:type_name -> ric.logic.v3.SchedulerInterval
	3,  // 28: ric.logic.v3.AutomatonInfo.VarsEntry.value:type_name -> ric.logic.v3.AutomatonVarValue
	3,  // 29: ric.logic.v3.StartAutomatonRequest.VarsEntry.value:type_name -> ric.logic.v3.AutomatonVarValue
	3,  // 30: ric.logic.v3.RunAutomatonRequest.VarsEntry.value:type_name -> ric.logic.v3.AutomatonVarValue
	3,  // 31: ric.logic.v3.UpdateAutomatonVarsRequest.VarsEntry.value:type_name -> ric.logic.v3.AutomatonVarValue
	3,  // 32: ric.logic.v3.UpdateAutomatonVarsResponse.VarsEntry.value:type_name -> ric.logic.v3.AutomatonVarValue
	9,  // 33: ric.logic.v3.RicLogicV3.GetInstanceInfo:input_type -> ric.logic.v3.GetInstanceInfoRequest
	17, // 34: ric.logic.v3.RicLogicV3.GetAutomatons:input_type -> ric.logic.v3.GetAutomatonsRequest
	11, // 35: ric.logic.v3.RicLogicV3.StartAutomaton:input_type -> ric.logic.v3.StartAutomatonRequest
	12, // 36: ric.logic.v3.RicLogicV3.StartAutomatonMulti:input_type -> ric.logic.v3.StartAutomatonMultiRequest
	14, // 37: ric.logic.v3.RicLogicV3.StopAutomaton:input_type -> ric.logic.v3.StopAutomatonRequest
	15, // 38: ric.logic.v3.RicLogicV3.RunAutomaton:input_type -> ric.logic.v3.RunAutomatonRequest
	19, // 39: ric.logic.v3.RicLogicV3.EmitEvent:input_type -> ric.logic.v3.EmitEventRequest
	21, // 40: ric.logic.v3.RicLogicV3.WaitEvent:input_type -> ric.logic.v3.WaitEventRequest
	24, // 41: ric.logic.v3.RicLogicV3.UpdateAutomatonVars:input_type -> ric.logic.v3.UpdateAutomatonVarsRequest
	26, // 42: ric.logic.v3.RicLogicV3.TouchEventSubscription:input_type -> ric.logic.v3.TouchEventSubscriptionRequest
	29, // 43: ric.logic.v3.RicLogicV3.GetSchedulerNextInvocation:input_type -> ric.logic.v3.GetSchedulerNextInvocationRequest
	10, // 44: ric.logic.v3.RicLogicV3.GetInstanceInfo:output_type -> ric.logic.v3.GetInstanceInfoResponse
	4,  // 45: ric.logic.v3.RicLogicV3.GetAutomatons:output_type -> ric.logic.v3.AutomatonInfo
	13, // 46: ric.logic.v3.RicLogicV3.StartAutomaton:output_type -> ric.logic.v3.StartAutomatonResponse
	13, // 47: ric.logic.v3.RicLogicV3.StartAutomatonMulti:output_type -> ric.logic.v3.StartAutomatonResponse
	16, // 48: ric.logic.v3.RicLogicV3.StopAutomaton:output_type -> ric.logic.v3.StopAutomatonResponse
	4,  // 49: ric.logic.v3.RicLogicV3.RunAutomaton:output_type -> ric.logic.v3.AutomatonInfo
	20, // 50: ric.logic.v3.RicLogicV3.EmitEvent:output_type -> ric.logic.v3.EmitEventResponse
	22, // 51: ric.logic.v3.RicLogicV3.WaitEvent:output_type -> ric.logic.v3.WaitEventResponse
	25, // 52: ric.logic.v3.RicLogicV3.UpdateAutomatonVars:output_type -> ric.logic.v3.UpdateAutomatonVarsResponse
	27, // 53: ric.logic.v3.RicLogicV3.TouchEventSubscription:output_type -> ric.logic.v3.TouchEventSubscriptionResponse
	30, // 54: ric.logic.v3.RicLogicV3.GetSchedulerNextInvocation:output_type -> ric.logic.v3.GetSchedulerNextInvocationResponse
...
func file_ric_logic_v3_riclogicv3_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ric_logic_v3_riclogicv3_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ric_logic_v3_riclogicv3_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TouchEventSubscriptionRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ric_logic_v3_riclogicv3_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TouchEventSubscriptionResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ric_logic_v3_riclogicv3_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SchedulerInterval); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ric_logic_v3_riclogicv3_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetSchedulerNextInvocationRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ric_logic_v3_riclogicv3_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetSchedulerNextInvocationResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type RicLogicV3Client interface {
	...
	WaitEvent(ctx context.Context, in *WaitEventRequest, opts ...grpc.CallOption) (*WaitEventResponse, error)
	...
	TouchEventSubscription(ctx context.Context, in *TouchEventSubscriptionRequest, opts ...grpc.CallOption) (*TouchEventSubscriptionResponse, error)
	GetSchedulerNextInvocation(ctx context.Context, in *GetSchedulerNextInvocationRequest, opts ...grpc.CallOption) (*GetSchedulerNextInvocationResponse, error)
}
...
func (c *ricLogicV3Client) WaitEvent(ctx context.Context, in *WaitEventRequest, opts ...grpc.CallOption) (*WaitEventResponse, error) {
	out := new(WaitEventResponse)
...
func (c *ricLogicV3Client) TouchEventSubscription(ctx context.Context, in *TouchEventSubscriptionRequest, opts ...grpc.CallOption) (*TouchEventSubscriptionResponse, error) {
	out := new(TouchEventSubscriptionResponse)
	err := c.cc.Invoke(ctx, "/ric.logic.v3.RicLogicV3/TouchEventSubscription", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ricLogicV3Client) GetSchedulerNextInvocation(ctx context.Context, in *GetSchedulerNextInvocationRequest, opts ...grpc.CallOption) (*GetSchedulerNextInvocationResponse, error) {
	out := new(GetSchedulerNextInvocationResponse)
	err := c.cc.Invoke(ctx, "/ric.logic.v3.RicLogicV3/GetSchedulerNextInvocation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RicLogicV3Server interface {
	...
	WaitEvent(context.Context, *WaitEventRequest) (*WaitEventResponse, error)
	UpdateAutomatonVars(context.Context, *UpdateAutomatonVarsRequest) (*UpdateAutomatonVarsResponse, error)
	TouchEventSubscription(context.Context, *TouchEventSubscriptionRequest) (*TouchEventSubscriptionResponse, error)
	GetSchedulerNextInvocation(context.Context, *GetSchedulerNextInvocationRequest) (*GetSchedulerNextInvocationResponse, error)
}
...
func (*UnimplementedRicLogicV3Server) WaitEvent(context.Context, *WaitEventRequest) (*WaitEventResponse, error) {
...
func (*UnimplementedRicLogicV3Server) TouchEventSubscription(context.Context, *TouchEventSubscriptionRequest) (*TouchEventSubscriptionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TouchEventSubscription not implemented")
}
func (*UnimplementedRicLogicV3Server) GetSchedulerNextInvocation(context.Context, *GetSchedulerNextInvocationRequest) (*GetSchedulerNextInvocationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSchedulerNextInvocation not implemented")
}
...
func _RicLogicV3_TouchEventSubscription_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TouchEventSubscriptionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RicLogicV3Server).TouchEventSubscription(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ric.logic.v3.RicLogicV3/TouchEventSubscription",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RicLogicV3Server).TouchEventSubscription(ctx, req.(*TouchEventSubscriptionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RicLogicV3_GetSchedulerNextInvocation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSchedulerNextInvocationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RicLogicV3Server).GetSchedulerNextInvocation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ric.logic.v3.RicLogicV3/GetSchedulerNextInvocation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RicLogicV3Server).GetSchedulerNextInvocation(ctx, req.(*GetSchedulerNextInvocationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _RicLogicV3_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TouchEventSubscription",
			Handler:    _RicLogicV3_TouchEventSubscription_Handler,
		},
		{
			MethodName: "GetSchedulerNextInvocation",
			Handler:    _RicLogicV3_GetSchedulerNextInvocation_Handler,
		},
	},
