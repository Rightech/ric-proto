...
var File_ric_echo_ricecho_proto protoreflect.FileDescriptor
...
var (
	file_ric_echo_ricecho_proto_rawDescOnce sync.Once
	file_ric_echo_ricecho_proto_rawDescData = file_ric_echo_ricecho_proto_rawDesc
)

func file_ric_echo_ricecho_proto_rawDescGZIP() []byte {
	file_ric_echo_ricecho_proto_rawDescOnce.Do(func() {
		file_ric_echo_ricecho_proto_rawDescData = protoimpl.X.CompressGZIP(file_ric_echo_ricecho_proto_rawDescData)
	})
	return file_ric_echo_ricecho_proto_rawDescData
}
...
func init() { file_ric_echo_ricecho_proto_init() }
func file_ric_echo_ricecho_proto_init() {
	if File_ric_echo_ricecho_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ric_echo_ricecho_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_ric_echo_ricecho_proto_goTypes,
		DependencyIndexes: file_ric_echo_ricecho_proto_depIdxs,
		MessageInfos:      file_ric_echo_ricecho_proto_msgTypes,
	}.Build()
	File_ric_echo_ricecho_proto = out.File
	file_ric_echo_ricecho_proto_rawDesc = nil
	file_ric_echo_ricecho_proto_goTypes = nil
	file_ric_echo_ricecho_proto_depIdxs = nil
}
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "ric-echo/ricecho.proto",
}
