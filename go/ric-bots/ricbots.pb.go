...
func (m *StartGeoRequest) Reset()         { *m = StartGeoRequest{} }
func (m *StartGeoRequest) String() string { return proto.CompactTextString(m) }
func (*StartGeoRequest) ProtoMessage()    {}
func (*StartGeoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bd134b2217701610, []int{8}
}

func (m *StartGeoRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_StartGeoRequest.Unmarshal(m, b)
}
func (m *StartGeoRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_StartGeoRequest.Marshal(b, m, deterministic)
}
func (m *StartGeoRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StartGeoRequest.Merge(m, src)
}
func (m *StartGeoRequest) XXX_Size() int {
	return xxx_messageInfo_StartGeoRequest.Size(m)
}
func (m *StartGeoRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_StartGeoRequest.DiscardUnknown(m)
}

var xxx_messageInfo_StartGeoRequest proto.InternalMessageInfo

func (m *StartGeoRequest) GetObjectId() string {
	if m != nil {
		return m.ObjectId
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*StartGeoRequest)(nil), "ric.bots.StartGeoRequest")
	proto.RegisterType((*SetBotConfigRequest)(nil), "ric.bots.SetBotConfigRequest")
}

func init() {
	proto.RegisterFile("ric-bots/ricbots.proto", fileDescriptor_bd134b2217701610)
}

var fileDescriptor_bd134b2217701610 = []byte{
	// 754 bytes of a gzipped FileDescriptorProto
	,
}
...
func (*UnimplementedBotsServer) StartGeo(ctx context.Context, req *StartGeoRequest) (*EmptyResponse, error) {
