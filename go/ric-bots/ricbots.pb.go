...
type SetConfigRequest_Gen_RandomType struct {
	...
	Send                 *SetConfigRequest_Gen_Send `protobuf:"bytes,3,opt,name=send,proto3" json:"send,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
func (m *SetConfigRequest_Gen_RandomType) GetSend() *SetConfigRequest_Gen_Send {
	if m != nil {
		return m.Send
	}
	return nil
...
func (m *SetConfigRequest_Gen_LinearType) GetSend() *SetConfigRequest_Gen_Send {
	if m != nil {
		return m.Send
	}
	return nil
...
var fileDescriptor_bd134b2217701610 = []byte{
	...
	,
}
