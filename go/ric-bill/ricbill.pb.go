...
var file_ric_bill_ricbill_proto_rawDesc = []byte{
	...
	0x52, 0x75, 0x6e, 0x52, 0x06, 0x64, 0x72, 0x79, 0x52, 0x75, 0x6e, 0x32, 0xd1, 0x05, 0x0a, 0x07,
...
var file_ric_bill_ricbill_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_ric_bill_ricbill_proto_depIdxs = []int32{
	...
	2,  // 12: ric.bill.Billing.SetupAccount:output_type -> ric.bill.SetupResponse
	2,  // 13: ric.bill.Billing.VerifyAccount:output_type -> ric.bill.SetupResponse
	2,  // 14: ric.bill.Billing.CloseAccount:output_type -> ric.bill.SetupResponse
	5,  // 15: ric.bill.Billing.CreateSubscription:output_type -> ric.bill.SubscriptionResponse
	5,  // 16: ric.bill.Billing.UpdateSubscription:output_type -> ric.bill.SubscriptionResponse
	5,  // 17: ric.bill.Billing.CancelSubscription:output_type -> ric.bill.SubscriptionResponse
	5,  // 18: ric.bill.Billing.ResumeSubscription:output_type -> ric.bill.SubscriptionResponse
	5,  // 19: ric.bill.Billing.ActivateSubscription:output_type -> ric.bill.SubscriptionResponse
	5,  // 20: ric.bill.Billing.DeactivateSubscription:output_type -> ric.bill.SubscriptionResponse
